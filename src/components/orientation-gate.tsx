    ...
    return (
        <div className="orientation-gate" role="alertdialog" aria-label="請轉直向">
            <div className="panel mx-4 flex max-w-sm flex-col items-center gap-4 px-6 py-8 text-center">
                <span className="border-felt-950 bg-gold-500 text-felt-950 animate-bob shadow-chunky flex size-16 rotate-90 items-center justify-center rounded-3xl border-3 text-3xl">
